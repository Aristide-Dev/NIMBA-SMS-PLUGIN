...
Keep package code, dependencies, and workflows compatible with the supported Laravel 11/12/13 and PHP 8.3+ matrix.

## Workflow

1. Read `composer.json` first to determine PHP, Laravel, and Testbench constraints.
2. Check changed code against Laravel 11/12/13 APIs and PHP 8.3+ syntax before adopting newer framework or language features.
...
- Review a new Laravel API call by checking whether it exists in Laravel 11, 12, and 13 before merging it into shared package code.
